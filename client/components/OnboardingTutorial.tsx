...
export default function OnboardingTutorial() {
  ...
  const steps = useMemo(
    () => [
      {
        title: "Bienvenue !",
        desc: "Voici comment fonctionne Brainrot Market.",
        action: null as any,
      },
      {
        title: "Acheter des RotCoins",
        desc: "Rendez-vous dans Boutique pour acheter des crédits via Payhip.",
        action: null as any,
      },
      {
        title: "Vendre un produit",
        desc: "Dans Marketplace, ajoutez un produit, il passera en vérification si nécessaire.",
        action: null as any,
      },
      {
        title: "Support & Tickets",
        desc: "Ouvrez un ticket si besoin d'aide. Notifications en temps réel.",
        action: null as any,
      },
    ],
    [],
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        const tos = (() => {
          try {
            return sessionStorage.getItem("tos_accepted") === "1";
          } catch {
            return false;
          }
        })();
